...
import {
  ...
  PcOverviewSection,
  PcTrainingRoadmap,
} from '../../components/training/PcTrainingOverviewSections'
import {
  PcResourcesSection,
  PcTrainingFinalCta,
  PcWarningsSection,
} from '../../components/training/PcTrainingReferenceSections'
...
export function PcTrainingPage({
  ...
  return (
    <PageShell>
      <PageHeader
        title="PC TRAINING"
        subtitle="Production Control onboarding · KVH Factory 2"
        mode={mode}
